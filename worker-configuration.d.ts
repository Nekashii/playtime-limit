// Generated by Wrangler by running `wrangler types` (hash: 4b4f90f304114c5b2efbcf7f2afc4c68)
// Runtime types generated with workerd@1.20250409.0 2025-04-02 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		STEAM_API_URL: string;
		STEAM_API_AUTH_TOKEN: string;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "STEAM_API_URL" | "STEAM_API_AUTH_TOKEN">> {}
}
